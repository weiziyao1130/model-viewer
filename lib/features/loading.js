...
export const LoadingMixin = (ModelViewerElement) => {
    return class extends ModelViewerElement {
        ...
        [$hidePoster]() {
            ...
            const onPosterHidden = () => {
                requestAnimationFrame(() => {
                    this.dispatchEvent(new CustomEvent('poster-visibility', { detail: { visible: false } }));
                    this[$canvas].focus();
                });
            };
            this[$posterHidden] = true;
            if (posterOpacity > 0) {
                ...
                posterElement.addEventListener('transitionend', onPosterHidden, { once: true });
            }
            else {
        ...
        [$showPoster]() {
            ...
            this.dispatchEvent(new CustomEvent('poster-visibility', { detail: { visible: true } }));
        }
        [$onClick]() {
            this.dismissPoster();
        }
